...
class Atributo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, tipo, calculado, tabla', 'required'),
			array('calculado, tabla', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>100),
			array('tipo', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_attributo, nombre, tipo, calculado, tabla', 'safe', 'on'=>'search'),
		);
	}
...
public function traer()
	...
	public function relations()
	{
		...
		return array(
			'tablas' => array(self::HAS_MANY, 'Tabla', 'id_attributo'),
			//'estudioAtributo' => array(self::HAS_MANY, 'Tabla', 'id_attributo'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('calculado',$this->calculado);
